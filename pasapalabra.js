...
const questions = [
  {
    ...
    status: 0,
    question1:
      "WITH THE LETTER A. Said of a supposed extraterrestrial creature: Seize someone",
    question2:
    ...
    answer2: "artery",
    question3:
      "WITH THE LETTER A. A word or phrase made by using the letters of another word or phrase in a different order.",
    answer3: "anagram",
  },
  {
    letter: "b",
    status: 0,
    question1:
      "WITH THE LETTER B. Game that has driven all the 'Skylabers' crazy in the pre-course sessions",
    answer1: "bingo",
    question2:
  ...
  },
  {
    ...
    answer2: "dance",
    question2:
      "WITH THE LETTER D. To move your body in a way that goes with the rhythm and style of music that is being played.",
    question3:
  ...
  },
  {
    ...
    status: 0,
    question1:
      "WITH THE LETTER E. Gelatinous and lies below the plasma membrane. Ghostbusters measured its radiation",
    answer1: "ectoplasm",
  ...
  },
  {
    ...
    status: 0,
    question1:
      "WITH THE LETTER F. That does not require great effort, capacity",
    answer1: "fair",
    question2:
      "WITH THE LETTER F. Strong belief or trust in someone or something.",
    answer2: "faith",
    question3:
      "WITH THE LETTER F. An unpleasant emotion caused by the threat of danger, pain, or harm.",
    answer3: "fear",
  },
  {
    letter: "g",
    status: 0,
    question1:
      "WITH THE LETTER G. Huge set of stars, interstellar dust, gases and particles",
    answer1: "galaxy",
    question2:
      "WITH THE LETTER G. Much larger or more powerful than normal. A legendary creature with this characteristics.",
    answer2: "giant",
    question3:
  ...
  },
  {
    ...
    answer1: "harakiri",
    question2:
      "WITH THE LETTER H. One of two equal or nearly equal parts into which something can be divided.",
    answer2: "half",
    question3:
      "WITH THE LETTER H. A settled or regular tendency or practice, especially one that is hard to give up.",
    answer3: "habit",
  },
  {
    letter: "i",
    status: 0,
    question1:
      "WITH THE LETTER I. Tony Stark is the alta-ego of which superhero?",
    answer1: "Ironman",
    question2: "WITH THE LETTER I. Not allowed by the law.",
    answer2: "illegal",
    question3:
      "WITH THE LETTER I. The faculty or action of forming new ideas, or images or concepts of external objects not present to the senses.",
    answer3: "imagination",
  },
  {
    letter: "j",
    status: 0,
    question1:
      "WITH THE LETTER J. Which Italian football club based in Turin wears black and white stripes?",
    answer1: "juventus",
    question2: "WITH THE LETTER J. Something said or done to cause laughter.",
    answer2: "joke",
    question3:
      "WITH THE LETTER J. An ornament or piece that contains a precious stone or stones.",
    answer3: "jewel",
  },
  {
    letter: "k",
    status: 0,
    question1:
      "WITH THE LETTER K. Person who risks his life carrying out a reckless action",
    answer1: "kamikaze",
    question2:
      "WITH THE LETTER K. A device that is used to open a lock or start an automobile.",
    answer2: "key",
    question3:
      "WITH THE LETTER K. A recurrent urge to steal, typically WITHhout regard for need or profit.",
    answer3: "kleptomania",
  },
  {
    letter: "l",
    ...
    answer2: "lazy",
    question2:
      "WITH THE LETTER L. Not liking to work hard or to be active. Slow and relaxed.",
  ...
  },
  {
    ...
    status: 0,
    question1:
      "WITH THE LETTER M. Person who flees from dealing with other people or feels great aversion towards them",
    answer1: "misanthrope",
    answer2: "milk",
    question2:
  ...
  },
  {
    ...
    answer1: "night",
    question2:
      "WITH THE LETTER N. Failure to take the care that a responsible person usually takes : lack of normal care or attention.",
    answer2: "negligence",
    question3:
      "WITH THE LETTER N. A person who has an excessive interest in or admiration of themselves.",
    answer3: "narcissist",
  },
  {
    letter: "o",
  ...
  },
  {
    ...
    status: 0,
    question1:
      "WITH THE LETTER P. Technologically advanced ancestral race characterized by its great psionic powers from the video game StarCraft",
    answer1: "protoss",
    answer2: "pair",
    question2:
      "WITH THE LETTER P. Two things that are the same and are meant to be used together.",
    question2:
      "WITH THE LETTER O. A state in which someone thinks about someone or something constantly or frequently especially in a way that is not normal.",
    answer2: "obsession",
    question3:
      "WITH THE LETTER P. An oval fleshy fruit which is purple, reddish, or yellow when ripe and contains a flattish pointed stone.",
    answer3: "plum",
  },
  {
    letter: "q",
    status: 0,
    question1:
      "WITH THE LETTER Q. A sentence worded or expressed so as to elicit information.",
    answer1: "question",
    question2:
      "WITH THE LETTER Q. A woman who rules a country and who usually inherits her position and rules for life.",
    answer2: "queen",
    question3:
      "WITH THE LETTER Q. A list of questions that several people are asked so that information can be collected about something.",
  ...
  },
  {
    ...
    answer1: "raton",
    question2:
      "WITH THE LETTER R. To feel sad or sorry about (something that you did or did not do).",
    answer2: "regret",
    question3:
      "WITH THE LETTER R. A full, deep, prolonged cry uttered by a lion or other large wild animal.",
    answer3: "roar",
  },
  {
    letter: "s",
    ...
    question2:
      "WITH THE LETTER S. An amount of money that an employee is paid.",
    answer2: "salary",
    question3:
      "WITH THE LETTER S. Used as a polite or respectful way of addressing a man, especially one in a position of authority.",
    answer3: "sir",
  },
  {
    letter: "t",
    status: 0,
    question1:
      "WITH THE LETTER T. Film by director James Cameron that established Arnold Schwarzenegger as an actor in 1984",
    answer1: "terminator",
  ...
  },
  {
    ...
    status: 0,
    question1:
      "WITH THE LETTER U. Spanish writer and philosopher of the generation of '98 author of the book 'Niebla' in 1914.",
    answer1: "unamuno",
    question2:
  ...
  },
  {
    ...
    answer2: "vegetarian",
    question3:
      "WITH THE LETTER V. The sound produced in a person's larynx and uttered through the mouth, as speech or song.",
    answer3: "voice",
  },
  {
    letter: "w",
    status: 0,
    question1:
      "INCLUDES THE LETTER W. Fast food made with two slices of bread between which ham and cheese are placed",
    answer1: "sandwich",
    question2:
    ...
    answer2: "wild",
    question3:
      "WITH THE LETTER W. A piece of rope holded by the extremes which serves to jump.",
    answer3: "warp",
  },
  {
    letter: "x",
    status: 0,
    question1:
      "INCLUDES THE LETTER X. Bacterial toxin used in cosmetic surgery.",
    answer1: "botox",
    question2:
      "Contains the letter X. To become or to cause (something) to become less tense, tight, or stiff.",
    answer2: "relax",
    question3:
      "Contains the letter X. A plane figure WITHh six straight sides and angles.",
    answer3: "hexagon",
  },
  {
    letter: "y",
    status: 0,
    question1:
      "INCLUDES THE LETTER Y. Small cactus known for its psychoactive alkaloids used ritually and medicinally by Native Americans.",
    answer1: "peyote",
    question2:
      "WITH THE LETTER Y. Used to give a positive answer2 or reply to a question2, request, or offer.",
    answer2: "yes",
    question3:
      "WITH THE LETTER Y. The time taken by the earth to make one revolution around the sun.",
    answer3: "year",
  },
  {
    letter: "z",
    status: 0,
    question1:
      "WITH THE LETTER Z. School of Buddhism that seeks the experience of wisdom beyond rational discourse",
    answer1: "zen",
    question2:
      "Contains the letter Z. A poisonous gas with a strong smell that is a form of oxygen.",
    answer2: "ozone",
    question3:
      "WITH THE LETTER Z. The scientific study of animals, especially their structure.",
    answer3: "zoology",
  },
];
...
const timeCheck = () => {
  ...
  if (Math.floor(millis / 1000) >= timeLimit) {
    ...
    console.log(
      `// Time left: ${timeLimit - Math.floor(millis / 1000)} seconds`
    );
  }
};
